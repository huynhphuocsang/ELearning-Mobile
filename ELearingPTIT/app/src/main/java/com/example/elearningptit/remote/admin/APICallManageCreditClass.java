...
public interface APICallManageCreditClass {
    ...
    Call<String> addStudentToCreditClass(@Header("Authorization") String token, @Query("credit-class-id") long creditClassId, @Body List<String> studentCode);

    @PUT("admin/creditclass/remove-student-from-credit-class")
    Call<String> removeStudentToCreditClass(@Header("Authorization") String token, @Query("credit-class-id") long creditClassId, @Body List<String> studentCode);
